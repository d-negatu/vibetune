...
This desktop prototype builds on the Spotify API and extends with features like vibe-based matching, real-time chats, playlist managment, OAuth authentication and vibe posts.
